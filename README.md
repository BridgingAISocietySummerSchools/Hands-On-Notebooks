...
Notebook 5 comes in four versions:
...
30 short calls per participant; the benchmark version makes about 105 and pins that small
model itself, which comes to roughly **5 cents per participant**.
